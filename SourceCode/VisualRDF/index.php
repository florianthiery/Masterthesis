...
<div>
   ...
   <table width="400" border="0" align="left" cellpadding="0" cellspacing="0">
  		<tr>
    <td align="left"><a href="http://graves.cl/visualRDF/" target="_blank" style="font-size:20px">VisualRDF</a>
    by <a href="http://graves.cl/" target="_blank">Alvaro Graves</a>
     | Code at <a href="https://github.com/alangrafu/visualRDF" target="_blank">Github</a></td>
    <td align="center"><input type="checkbox" checked id="properties"/ width="10">
      <label>Hide properties</label>
    <input type="hidden" id="hidePredicates"/>
      <!--<label>Hide predicates</label>--></td>
  </tr>
</table>
...
<div style="border-width: 1px; border-style: solid;width:400px;min-height:400px;height:100%" id='chart'></div>
